 ...
 *
 * This file is view only — `useFriendsViewModel` owns the search state and
 * derived list; `FriendSelection.ts` owns the actual selection rules shared
 * with the map. Nothing here decides what "all" or a filtered row means.
 */
...
export function FriendsScreen({
  ...
  const { query, setQuery, filtered, allSelected, visibleCount, isChecked } = useFriendsViewModel({
    roster,
    mode,
    selectedIds,
  });
